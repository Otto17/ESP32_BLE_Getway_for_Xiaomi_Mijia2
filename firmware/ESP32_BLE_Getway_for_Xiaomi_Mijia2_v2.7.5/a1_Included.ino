...
#include <EncButton.h>              // Библиотека для работы с кнопками "https://github.com/GyverLibs/EncButton" [используется ver. 3.4.0]
...
#include <Watchdog.h>               // Библиотека для удобного управления Watchdog в коде "https://github.com/meirarc/Watchdog" [используется ver. 0.1]
...
//Watchdog
Watchdog wdt(WATCHDOG_TIME);  //  Создаём объект "wdt" класса "Watchdog" с периодом времени "WATCHDOG_TIME"
