...
#define WATCHDOG_TIME 20  // Период времени для сторожевого таймера (в секундах), при превышении которого ESP32 перезагрузится (в случаи зависания)
...
#define SET_MAC_KOMNATA "FF:FF:FF:FF:FF:FF"  // MAC адрес датчика "Xiaomi Mijia 2", который установлен в комнате. Можно узнать MAC через любой BLE сканер со смарфона
#define SET_MAC_KYXNYA "FF:FF:FF:FF:FF:FF"   // MAC адрес датчика "Xiaomi Mijia 2", который установлен на кухне. Можно узнать MAC через любой BLE сканер со смарфона
