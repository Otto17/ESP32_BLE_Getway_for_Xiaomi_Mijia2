/*
  ...
  5) Там же на странице настроек сразу меняем Пароль для OTA (всегда используйте сложные пароли), остальные пункты по желанию.
  ...
  1) Плата "ESP32 Dev Module" (версия платы 2.0.14)
  ...
  Убрал "mDNS", так как с WEB OTA от "EspMQTTClient" работать не хочет, да и изначально сомневался стоит ли его добавлять только для OTA. (Версия: 2.7.5, Дата создания: 09.10.2023г.)


  Дата создания: 09.10.2023г.
  Версия: 2.7.5
  Автор: Otto.
